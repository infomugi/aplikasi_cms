<form method="post" id="avatar_form" align="center" enctype="multipart/form-data"> 
  <div class="col-md-10 form-normal form-horizontal clearfix">
    ...
    <input type="hidden" name="id_setting_slide" value="<?php echo $id_setting_slide; ?>" /> 
    <a href="<?php echo site_url('slide') ?>" class="btn btn-default pull-right">Cancel</a>
  </div></form>
     ...
     {  
      $.ajax({  
        ...
        {  
          ...
          swal({
            title: 'Sukses!',
            text: 'Icon Services berhasil di Perbaharui',
            type: 'success',
